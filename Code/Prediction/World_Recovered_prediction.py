...
plt.plot_date(x,y_pred1,color='green',linestyle='solid', marker='x')
plt.title('World-wide Recovery')
plt.xlabel('Date')
plt.ylabel('Number of people')
plt.xlim([min(dated_count),max(dated_count)+2])
plt.ylim([0,max(Rec)+10000])
fig = plt.gcf()
...
print(df)
df.to_csv("D:\python\COVID19\Output\Dataframes\Recovery_pred50.csv")

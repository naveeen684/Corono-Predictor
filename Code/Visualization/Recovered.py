...
for x in range(len(unique_count)):
    ...
    #ax.plot_date(dates, Con,linestyle='solid', marker='o')
    #ax.plot_date(dates, death,linestyle='solid', marker='x')
    ax.plot_date(dates, Rec,linestyle='solid', marker='3')
...
plt.title("Worldwide Recovered for Covid-19 outbreak status")
fig = matplotlib.pyplot.gcf()
fig.set_size_inches(25.5, 10.5)
fig.savefig('Worldwide Recovered for Covid-19 outbreak status.png', dpi=100)    
plt.show()
